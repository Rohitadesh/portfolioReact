        ...
        <> 
            <div className="h-[7%] w-full max-[630px]:h-[7%] overflow-hidden">
                    ...
                    <div className="min-[640px]:hidden dropdown dropdown-right ml-2">
                        ...
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-80 flex flex-row flex-wrap justify-start
                         border-black border 
                            ">
                            {/* <l1><a>home</a></l1> */}
                            {
                                label.map((element,index)=>{
                                    return (
                                        <li key={index} ><Link to={element.path} className='text-xs'>{element.place}</Link></li>
                                    )
                                })
                            }
                        </ul>
